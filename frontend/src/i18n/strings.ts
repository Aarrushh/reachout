...
const STRINGS = {
  ...
  "retail.index.explainer": { es: "Los porcentajes de los gráficos son el cambio del interés de búsqueda frente a la semana anterior, medido sobre un índice relativo. No son ventas, ni clientes, ni cuota de mercado: sirven para comparar productos dentro de la misma vista.", en: "The percentages in the charts are the change in search interest against the previous week, measured on a relative index. They are not sales, customers or market share: use them to compare products within the same view." },
